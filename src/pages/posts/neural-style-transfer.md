...
The contribution of each layer in the style information is calculated by the formula below: $E_l=\frac{1}{4 N_l^2 M_l^2} \sum_{i, j}\left(G_{i j}^l-A_{i j}^l\right)^2$
